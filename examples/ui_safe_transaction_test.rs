...
pub fn random_essence(
    ...
    ledger.set_account(Protocol::Stardust, chain, account)?;
...
pub fn main() -> Result<(), Box<dyn Error>> {
    ...
    let mut ledger = iota_ledger_nano::get_ledger_by_type(Protocol::Stardust, chain, HARDENED, &transport_type, None)?;
