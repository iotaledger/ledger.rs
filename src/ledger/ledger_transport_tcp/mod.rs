...
mod errors;
pub use errors::TransportTcpError::ReadCannotDeserialize;
pub use errors::TransportTcpError;
//use crate::zondax::ledger_transport_tcp::TransportTcpError::ReadCannotDeserialize;
use byteorder::{BigEndian as BE, WriteBytesExt};
use crate::ledger::ledger_apdu::{APDUAnswer, APDUCommand};
use std::ops::Deref;
