...
pub fn exec(transport: &crate::Transport, block_number: u8) -> Result<Response, errors::APIError> {
    let cmd = APDUCommand {
...
pub fn read(transport: &crate::Transport, size: usize) -> Result<Vec<u8>, errors::APIError> {
...
pub fn memory_dump(transport: &crate::Transport, filename: String) -> Result<(), errors::APIError> {
